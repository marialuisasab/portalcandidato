                ...
                <div class="card-body" style="box-sizing: border-box; margin-top: 30px;">
                    ...
                    <div class="container">
                        ...
                        {{-- <div class="row" style="margin-top: 50px;">
                            <div class="col-sm">
                                <h5 id="quantidade_de_curriculos"
                                    style="color: green; text-shadow: black 0.1em 0.1em 0.2em">Quantidade de curriculos
                                </h5>
                            </div>
                            <div class="col-sm" id="col_quantidade"
                                style="color:green; text-shadow: black 0.1em 0.1em 0.2em">
                            </div>
                        ...
                        <div class="row" style="margin-top: 50px;">
                            <div class="col-sm">
                                ...
                                <div class="d-flex flex-row bd-highlight mb-3">
                                    ...
                                    {{-- <div class="p-2 bd-highlight">{{$parametros['pcdmodal']}}
                                </div> --}}
                    ...
                    <div class="row">
                        <div class="col-sm">
                            {{-- <ul>
                                <li>
                                    Mostrando de {{$users->firstItem()}} a {{$users->lastItem()}}
                            </li>
                            <li>
                                Página {{ $users->currentPage() }}
                            </li>
                            <li>
                                Quantidade por página {{ $users->count() }}
                            </li>
                            <li>

                            </li>
                            </ul> --}}
                            <p>Página {{ $users->currentPage() }}</p>
