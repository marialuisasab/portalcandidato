...
<div class="card-header" id="HeaderID">
  <img src="/img/ImagemUsuario.png" alt="" width="40" height="40" style="justify-content: center" id="ImagemUsuario">
  <h3 class="font-italic" style="font-size: 15px;">Meu Login</h3>
</div>
  ...
  <form method="POST" action="{{ route('login') }}" id="formulariologin">
    ...
    <div class="input-group mb-3">
      ...
      <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email"
        ...
        title="Preencha com seu email">

      <div class="input-group-append">
        <span class="input-group-text" id="basic-addon2"><span class="fas fa-envelope-square"
            id="TamEnvelope"></span></span>
      </div>
    ...
    <div class="input-group mb-3">
      ...
      <input id="password" type="password" class="form-control @error('password') is-invalid @enderror" name="password"
        required autocomplete="current-password" placeholder="Senha" title="Preencha com sua senha">
    ...
    <div class="form-group" style="  text-align: center;">
      <a class="btn btn-link" href="{{ route('password.request') }}" id="botaoesqueceu"
        title="Clique aqui se esqueceu sua senha">
