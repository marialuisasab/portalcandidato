...
<div class="card-header" id="HeaderID">
    <span class="fas fa-file-medical" style="font-size: 25px; width: 40px; height: 40px;"></span>
    <h3 class="font-italic" style="font-size: 15px;">Recuperação de senha</h3>
</div>
...
<div class="container" id="containerRecuSenha">
    <div class="row" style="margin-top: 100px;">
        <h5 class="text-center"><em> Insira seu email cadastrado no sistema! Neste email, você receberá um link para
                gerar uma nova senha.</em></h5>
