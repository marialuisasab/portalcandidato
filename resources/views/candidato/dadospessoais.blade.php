...
<div class="form">
  ...
  <div class="form-group">
    ...
    <input type="text" name="identidade"class="form-control" id="identidade" placeholder="Insira o codigo de sua identidade">
  </div>
   <div class="form-group">
    <label for="datanascimento">Data de Nascimento:</label>
    <input type="text" name="datanascimento"class="form-control" id="datanascimento" placeholder="Insira a data do seu nascimento">
  </div>
