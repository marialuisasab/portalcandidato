									...
									<div class="form-group">
										<li><strong>FOTO:&nbsp;&nbsp;&nbsp;</strong><span> </span>
											...
											<input type="file" class="form-control-file" id="foto" name="foto"
												file_extension=".jpg" accept='image/*' value="{{$c->idcurriculo}}"
									...
									<div class="form-group">
										<li><strong> GENERO:*&nbsp;&nbsp;&nbsp;</strong>
											<select class="form-control" id="genero" name="genero"
												value="{{$c->genero}}" title="Genero">
												<option value="" id="idselecionargen"
													{{$c->genero == null ? 'selected' : ''}}>
													Selecionar</option>
												<option value="F" id="idselecionargen"
													{{$c->genero == 'F' ? 'selected' : ''}}>
													Feminino</option>
												<option value="M" id="idselecionargen"
													{{$c->genero == 'M' ? 'selected' : ''}}>
													Masculino</option>
												<option value="N" id="idselecionargen"
													{{$c->genero == 'N' ? 'selected' : ''}}>
									...
									<div class="form-group">
										<li style=""><strong> NOME DA MÃE:*&nbsp;&nbsp;&nbsp;</strong>
											<input type="text" class="form-control" name="nomemae" id="nomemae"
												placeholder="Nome da mãe" value="{{$c->nomemae}}"
									...
									<div class="form-group">
										<li><strong> NOME DO PAI:&nbsp;&nbsp;&nbsp;</strong>
											<input type="text" class="form-control" name="nomepai" id="nomepai"
												placeholder="Nome do pai" value="{{$c->nomepai}}"
												title="Nome do Seu Pai">
										</li>
									</div>
									...
									<div class="form-group">
										<li><strong> PESSOA COM DEFICIÊNCIA:*&nbsp;&nbsp;&nbsp;</strong>
											<select class="form-control" id="dfisico" name="dfisico"
												value="{{$c->dfisico}}" title="Deficiência Fisíca">
												<option value="" {{$c->dfisico == null ? 'selected' : ''}} selected>
													Selecionar
												</option>
