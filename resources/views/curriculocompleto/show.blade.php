                            ...
                            @foreach($users as $c)
                                   ...
                                   <ul style="list-style-type: none;">
                                        <li>
                                            @if(Helper::getIdAdmin())                                                
                                                <a class="badge badge-info badge-sm" href="{{route('Curriculo.Impressao',$c->idcurriculo)}}">
                                                    Baixar arquivo em PDF
                                                </a>
                                            @else
                                                <a class="badge badge-info badge-sm" href="/imprimirCurriculo/{{$c->idcurriculo}}">
                                                    Baixar arquivo em PDF
                                                </a>
                                            @endif
                                        </li>
                                            <li>                                                                
                                            @if($c->foto != null)                                        
                                                <img src="{{url('/fotos/'.$c->foto)}}" alt="{{$c->name}}" style="max-width: 120px; border-radius: 50%;">                                        
                                            @else                                        
                                                <img class="profile-user-img img-responsive img-circle" src="/img/usuariopadrao.png" alt="Sem foto" style="color: red;">                                    
                                            @endif
                                        </li>
                                        <li>
                                ...
                                <ul style="list-style-type: none;">
                                    ...
                                    @if($c->naturalidade != null)
                                        <li>
                                            <strong> NATURALIDADE:&nbsp;&nbsp;&nbsp;</strong>{{Helper::getCidade($c->naturalidade)}}
                                        </li>
                                    @else
                                        <li>
                                    ...
                                    @if(($c->dfisico != null) && ($c->dfisico == '1'))
                                        <li>
                                            <strong> DEFICIENTE FISÍCO:&nbsp;&nbsp;&nbsp;</strong> 
                                            Sim
                                        </li>
...
<!--------------------------------------------------------------------------------------------------------------->
                            ...
                            @foreach($endereco as $e)                          
                                ...
                                <ul style="list-style-type: none;">
                                    ...
                                    <br>
                                    <li>
                                        <strong> ESTADO:&nbsp;&nbsp;&nbsp;</strong>{{Helper::getEstado($e->estado_idestado)}}
                                    </li>
                                    <br>
                                    <li>
                                        <strong> CIDADE:&nbsp;&nbsp;&nbsp;</strong>{{Helper::getCidade($e->cidade_idcidade)}}
                                    </li>
                                    <br>
                                    <li>
                                        <strong> PAÍS:&nbsp;&nbsp;&nbsp;</strong>
                                    ...
                                    <br>
                                    <li>
                                        <strong> POSSUI DISPONIBILIDADE PARA MUDANÇA? &nbsp;&nbsp;&nbsp;</strong>{{$e->disp_mudanca == '1' ? 'Sim':'Não'}}
                                    </li>                                                                        
                                </ul>
                            @endforeach
<!------------------------------------------------------------------------------------------------------------------->
                                    ...
                                    <div class="row" style="margin-top: 25px;">
                                        <div class="col-sm">
                                            <ul class="item-ii" style="list-style-type: none; margin-right: auto;">
                                                ...
                                                @if ($c->escolaridade == '2')
                                                    <li class="item-2">
                                                        <strong> CATEGORIA:&nbsp;&nbsp;&nbsp;</strong>{{Helper::getCategoria($c->categoria_idcategoria)}}
                                                    </li>
                                                    <br>                                                
                                                @endif
                                                ...
                                                ?>
                                                    @foreach ($vetorniveisNsuperior as $niveis)
                                                        ...
                                                        @endif
                                                    @endforeach
                                                @else <!-- Se a escolaridade for 2 e os niveis forem -->
                                                    @if ($c->escola != null)
                                                        <li class="item-2">
                                                            <strong> INSTITUIÇÃO&nbsp;&nbsp;&nbsp;</strong>
                                                                {{$c->escola}}
                                                ...
                                                <li class="item-2">
                                                    <strong> DATA DE INÍCIO:&nbsp;&nbsp;&nbsp;</strong>{{Helper::getData($c->dtinicio)}}
                                                </li>
                                                <br>
                                                ...
                                                @else
                                                    <li class="item-2">
                                                        <strong> DATA DE CONCLUSÃO:&nbsp;&nbsp;&nbsp;</strong>{{Helper::getData($c->dtfim)}}
                                                    </li>
                                                @endif
                                                <br>
                                            </ul>
                                    ...
                                    <div class="row" style="margin-top: 25px;">
                                        <div class="col-sm">
                                            <ul style="list-style-type: none; margin-right: auto;">
                                                ...
                                                @if ($e->dtfim != null)
                                                    <li>
                                                        <strong> DATA DE SAÍDA:&nbsp;&nbsp;&nbsp;</strong>{{Helper::getData($e->dtfim)}}
                                                    </li>
                                                @else
                                                    <li>
                            ...
                            <div class="container">
                                <div class="row" style="margin-top: 25px;">
                                    <div class="col-sm">                                        
                                        <ul style="list-style-type: none; margin-right: auto;">
                                            <li>
                                                <strong> CATEGORIA:&nbsp;&nbsp;&nbsp;</strong>{{Helper::getTipoHab($i->tipo_idtipo)}}
                                            </li>
                                            <br>
                                            <li>
                        ...
                        <tbody>
                            @foreach ($curriculovaga as $processo)                            
                                <tr>
                                    ...
                                    <td> 
                                        <a class="badge badge-info badge-sm" href="/detalhes/{{$processo->vaga_idvaga}}" role="button">Visualizar Vaga</a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
