                        ...
                        <div id="collapseOne" class="collapse show" aria-labelledby="headingOne"
                            ...
                            @foreach($users as $c) 
                                    ...
                                    <div class="col" style="text-align: center;"> 
                                        <div class="row">                                      
                                            @if($c->foto != null)                                        
                                                <img src="{{public_path('/fotos/'.$c->foto)}}" alt="{{$c->name}}" style="max-width: 120px; border-radius: 50%;">
                                            @else                                        
                                                <img class="profile-user-img img-responsive img-circle" src="{{public_path('img/usuariopadrao.png')}}" alt="Sem foto" style="color: red;">                                    
                                            @endif
                                        </div>
                                        <div class="row">                                            
...
<!------------------------------------------------------------------------------------------------------------------->                     
                                ...
                                @foreach ($endereco as $e)                                    
                                    <ul style="list-style-type: none;">
                                        ...
                                        <li>
                                            <strong> DISPONIBILIDADE DE MUDANÇA:&nbsp;&nbsp;&nbsp;</strong>{{$e->disp_mudanca == '1' ? 'Sim':'Não'}}
                                        </li>
                                    </ul>                                
                                @endforeach
<!---------------------------------------------------------------------------------------------------------------->
