                            ...
                            <div class="card-body" style="box-sizing: border-box;">
                                ...
                                <ul style="list-style-type: none;">
                                    ...
                                    @if($candDados->foto != null)
                                        ...
                                        <img src="{{public_path('fotos/'.$candDados->foto)}}" alt="" height="75px" style=" max-width: 80px; border-radius: 50%;">
                                   
                                    @else
                                        <img class="profile-user-img img-responsive img-circle"
                                            src="{{public_path('img/usuariopadrao.png')}}" alt="Usuário sem foto"  style=" max-width: 60px; border-radius: 50%;">
