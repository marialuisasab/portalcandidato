                    ...
                    <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
                        <div class="card-body" style="box-sizing: border-box;">
                            <ul style="list-style-type: none;">
                                ...
                                <form action="/salvarvaga" method="POST" enctype="multipart/form-data"
                                    id="idformselect">
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        <li><strong>TÍTULO:*&nbsp;&nbsp;&nbsp;</strong>
                                            <input type="text" class="form-control"
                                                placeholder="Ex.: Auxiliar de Envase" name="titulo" id="idtitulo"
                                                title="Título da vaga" value="{{$v->titulo}}">
                                    ...
                                    <div class="form-group">
                                        <li><strong> DATA DE INÍCIO:*&nbsp;&nbsp;&nbsp;</strong>
                                            <input type="date" class="form-control " name="dtinicio" id="iddtinicio"
                                                title="Data de inicio da postagem" value="">
                                    ...
                                    <div class="form-group" id="background_pcd">
                                        <li><strong> PCD:*&nbsp;&nbsp;&nbsp;</strong>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="pcd" id="pcd"
                                                    value="1" {{ $v->pcd == '1' ? 'checked' : '' }}>
                                                <label class="form-check-label">Sim</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="pcd" id="pcd"
                                                    value="2" {{ $v->pcd == '2' ? 'checked' : '' }}>
